...
// Multi-sport (bloc 0) : état affiché à la place du contenu réel pour un sport pas
// encore branché (basket/tennis) — jamais une erreur, jamais une page blanche, jamais
// une donnée inventée (voir PROMPT, règle "aucune donnée fictive"). Même style de
// carte que le reste de l'app. `pageLabel` décrit la section affichée (ex: "Matchs à
// venir") pour que le message reste concret plutôt que générique.
