...
const st = {
  ...
  pinnedPanel: {
    ...
    background: "#FFFFFF", border: "1px solid #39B577", borderRadius: 14, padding: 18,
    boxShadow: "0 6px 18px rgba(20,60,40,0.15)",
  },
  ...
  descText: { fontSize: 12, color: "#5C7A6A", margin: "14px 0 0", lineHeight: 1.5 },
  infoGrid: { display: "flex", flexWrap: "wrap", gap: 8, marginTop: 14 },
  infoCell: { flex: "1 1 calc(33.333% - 6px)", minWidth: 100, background: "#EEF5F0", borderRadius: 8, padding: "8px 10px" },
  infoLabel: { display: "block", fontSize: 9.5, color: "#5C7A6A", textTransform: "uppercase" },
  infoValue: { fontSize: 12.5, fontWeight: 600 },
  divider: { borderTop: "1px solid #D8E6DE", margin: "16px 0" },
  h2: { fontSize: 15, margin: "0 0 4px" },
  liveHint: { fontSize: 11, color: "#C0392B", margin: "0 0 12px" },
