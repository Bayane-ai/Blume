...
// à l'authentification (connexion, inscription, accueil...), ça plantait TOUT le site
// avec l'écran d'erreur générique de Next.js, sans aucun indice sur la cause réelle.
// On avale cette erreur ici et on expose à la place un client qui échoue proprement,
// avec un message diagnostiquable (console + erreur affichée via friendlySignupError/
// friendlySigninError), plutôt qu'un crash muet dès l'arrivée sur la page.
