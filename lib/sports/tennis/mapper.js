...
// (déjà écrits pour le football/basket) affichent un match de tennis sans la moindre
// modification. Identifiants préfixés "tn-" (jamais "af-"/"bk-", déjà utilisés) : un
// id de match/joueur/tournoi tennis ne doit jamais, même par coïncidence, être
// confondu avec un id d'un autre sport par le reste du site.
//
