...
// d'actualités football en français (L'Équipe, Foot Mercato, So Foot...) sont de
// vrais flux RSS 2.0 publics, pas besoin de clé API. On extrait uniquement les champs standard
...
// `sourceName` est le nom affiché de la source (ex : "L'Équipe") — jamais déduit du
