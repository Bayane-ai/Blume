...
// Attributs EXACTS demandés (voir PROMPT, "Cookie de session") : httpOnly, secure,
// sameSite=lax, path=/. `secure: true` est sans risque même en développement local
// sur http://localhost : les navigateurs (Chrome, Firefox) traitent localhost comme
// une origine "potentiellement de confiance" et acceptent quand même les cookies
// Secure dessus — seul un http://IP-ou-domaine-non-local sans TLS perdrait le cookie,
// ce qui ne doit de toute façon jamais arriver en production (toujours servie en
// https:// sur Vercel).
