...
// getFixtureStatistics / mapFixtureStatistics (GET /fixtures/statistics — corners/
// hors-jeu/fautes réellement comptabilisés en direct) ont été RETIRÉS : ils servaient
// uniquement à recalculer les blocs Corners/Hors-jeu/Fautes en direct
// (lib/pronostic.js, buildMatchStats), un comportement retiré à la demande explicite
// de l'utilisateur — les pronostics doivent rester figés, calculés une seule fois
// avant le match (voir pages/api/analyze.js et lib/pronosticHistory.js).
