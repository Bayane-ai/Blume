...
export async function saveFrozenPrediction({
  matchId, competitionCode, homeTeamName, awayTeamName, matchDate, result, matchStatus, finalScore,
}) {
...
export async function verifyFrozenPrediction(matchId, finalScore) {
  ...
  try {
    ...
    const status = classifyOutcome(pendingRow.prediction, finalScore) || "pending";
