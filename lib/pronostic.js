...
// computeLivePronostic (qui recalculait les probabilités et les lignes de marché à
// partir du score et de la minute en direct) a été RETIRÉ à la demande explicite de
// l'utilisateur : les pronostics doivent rester figés, calculés une seule fois avant
// le match, pour servir de référence stable au parieur — voir pages/api/analyze.js
// (le pronostic figé est calculé une seule fois via computePronostic, jamais
// recalculé pendant le match) et lib/pronosticHistory.js (mécanisme de gel). Seuls le
// score, la minute et la timeline d'événements restent réellement en direct.
