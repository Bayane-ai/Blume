...
function formatGoals(x) {
  return String(x).replace(".", ",");
}

function totalReason(goals, hName, aName) {
...
function totalTeamReason(teamName, expected, opponentName) {
...
// texte inventé).
function splitReason(labelPlural, stat, hName, aName) {
...
function redCardReason() {
  return "Un carton rouge reste un évènement rare en football professionnel : l'estimation pour ce match reste proche de zéro, quelle que soit l'équipe.";
}
...
export function buildSelectionCandidates({ probabilities, homeTeamName, awayTeamName, markets, extraStats, home, away, goals }) {
  ...
  pushLine("Cartons rouges", markets.redCards.safe, "redCards", redCardReason());
