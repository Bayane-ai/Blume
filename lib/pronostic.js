...
export function buildSelectionCandidates({ probabilities, homeTeamName, awayTeamName, markets, extraStats, home, away, goals }) {
  ...
  pushLine("Tirs", riskLines(raw.shotsTotal).safe, "shots", splitReason("tirs", extraStats.shots, hName, aName));
  pushLine("Tirs cadrés", riskLines(raw.shotsOnTargetTotal).safe, "shotsOnTarget", splitReason("tirs cadrés", extraStats.shotsOnTarget, hName, aName));
  pushLine("Corners", riskLines(raw.cornersTotal).safe, "corners", splitReason("corners", extraStats.corners, hName, aName));
  pushLine("Hors-jeu", riskLines(raw.offsidesTotal).safe, "offsides", splitReason("hors-jeu", extraStats.offsides, hName, aName));
  pushLine("Fautes", riskLines(raw.foulsTotal).safe, "fouls", splitReason("fautes", extraStats.fouls, hName, aName));
  pushLine("Touches", riskLines(raw.throwInsTotal).safe, "throwIns", splitReason("touches", extraStats.throwIns, hName, aName));
